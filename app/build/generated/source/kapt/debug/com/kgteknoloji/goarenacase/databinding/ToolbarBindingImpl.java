...
public class ToolbarBindingImpl extends ToolbarBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.toolbar_btn_search, 1);
    }
    // views
    // variables
    // values
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.kgteknoloji.goarenacase.viewmodel.VMToolbar) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.kgteknoloji.goarenacase.viewmodel.VMToolbar Viewmodel) {
